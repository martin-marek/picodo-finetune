...
Taken from https://github.com/google-deepmind/optax/blob/main/optax/_src/factorized.py
Only 2 LOC were modified to hard-code scale_by_factored_rms state dtype to float32.
"""
...
def scale_by_factored_rms(
  ...
  def init_fn(params):
    ...
    def _init(param):
      shape, dtype = param.shape, jnp.float32 # <-- CHANGED TO HARD-CODE FLOAT32
